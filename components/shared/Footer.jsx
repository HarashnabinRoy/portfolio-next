        ...
        <div>
            <div className="text-[#5d5a5a99] flex flex-wrap justify-between mt-16 mb-4 text-xs md:mx-[200px] mx-6 ">
                <div className="flex gap-4">
                    <a href="mailto:harashnabin2002@gmail.com" className= {`hover:text-${selectedColor} transition duration-200 ease-in-out`} target="_blank"><FontAwesomeIcon icon={ faEnvelope } /> Contact</a>

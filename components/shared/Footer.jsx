...
const Footer = () => {
    return(
        <div>
            <div className="text-[#5d5a5a99] flex flex-wrap justify-between mt-16 mb-4 text-xs mx-[200px] ">
                <div className="flex gap-4">
                    <a href="harashnabin2002@gmail.com" className="hover:text-[#908e8e] transition duration-200 ease-in-out" target="_blank"><FontAwesomeIcon icon={ faEnvelope } /> Contact</a>

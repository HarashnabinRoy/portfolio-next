...
const Landing = () => {
    return(
        <div className="p-20">
            ...
            <p className="mt-20 w-1/2 tracking-tighter" >I am a fullstack web developer specializing in React and Next<span className="text-[#2bbc8a]">.</span>JS. Currently I'm focused in getting my undergrad degree in Computer Science and Engineering from <a href="" className="text-[#2bbc8a] hover:underline underline-offset-2">SRM Institute of Technology</a>.</p>
        </div>
    );
};

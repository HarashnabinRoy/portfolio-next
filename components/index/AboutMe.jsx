        ...
        <div className="md:py-20 pb-20 pt-10 md:px-40 px-8 snap-start"> 
            ...
            <div className="flex mt-20 py-[50px] md:flex-row flex-col gap-20">
                <div className=" md:w-[800px] tracking-tighter px-6 md:px-20">
                    ...
                    <p className="mt-4">I've recently grown an interest in <span className="underlineEffect" style={{color:color}}>Blockchain and Web3</span> and am doing various courses and research work on it.</p>
